...
public class BeforeEvent extends InvokeEvent {
    ...
    public BeforeEvent(final int processId,
        ...
        super(processId, invokeId, Event.Type.BEFORE);
        System.out.println("这里创建了一个BeforeEvent,processId::" + processId + " javaClassName::" + javaClassName + " javaMethodName::" + javaMethodName);
    ...
    public BeforeEvent changeParameter(final int index,
        ...
        System.out.println("changeParameter");
