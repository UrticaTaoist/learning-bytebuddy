...
import com.alibaba.jvm.sandbox.api.util.matcher.structure.*;
...
import static com.alibaba.jvm.sandbox.api.util.SandboxStringUtils.toInternalClassName;
        ...
        try {
            ...
            if (classStructure instanceof ClassStructureImplByJDK
                ...
                try {
                    ...
                    _matching(ClassStructureFactory.createClassStructure(Class.forName(classStructure.getJavaClassName())));
